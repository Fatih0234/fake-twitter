...
<h3 align="center">A passionate data scientist/developer.</h3>



<p align="left">
I have built a fake twitter where you can sign up and then log-in.
You got timeline page where you can have a timeline of yours or others and can see the 
contents. Moreover, you have a profile page or you can check other's profiles and see their informations and tweets. 
It is supported by a relational database. 
</p>
